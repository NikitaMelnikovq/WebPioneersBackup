(() => {
    ...
    (() => {
        ...
        da.init();
        let languageButton = document.querySelector(".header-switch-language");
        let languageMenu = document.querySelector(".header-language__menu");
        let language_icon = document.querySelector(".header-language__icon");
        languageButton.addEventListener("click", (e => {
            languageMenu.classList.toggle("languageMenu__active");
            language_icon.classList.toggle("languageIcon__active");
        }));
        ...
        console.log("Системный язык: " + userLanguage);
        window["FLS"] = true;
        isWebp();
        spollers();
        tabs();
